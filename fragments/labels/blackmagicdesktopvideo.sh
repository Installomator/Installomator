blackmagicdesktopvideo)
    ...
    downloadURL=$(curl --compressed --location --header "Content-Type: application/json;charset=UTF-8" --header "User-Agent: Mozilla/5.0" --data '{"country": "us", "platform": "Mac OS X", "product": "Desktop Video"}' "https://www.blackmagicdesign.com/api/register/us/download/${downloadID}")
