jre8)
    ...
    versionURL=$(curl -fs "https://javadl-esd-secure.oracle.com/update/mac/map-mac-1.8.0.xml" | xpath '( //java-update-map/mapping/url)' 2>/dev/null | tail -n1 | cut -d\> -f2 | cut -d\< -f1)
